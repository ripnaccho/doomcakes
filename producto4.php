...
<head>
  <meta charset="UTF-8" />
  <title>Panadería Maldivas - Red Velvet</title>
  <style>
...
$tortasVelvet = [
  'torta13' => [
    'nombre' => 'Red Velvet Clásica',
    'imagen' => 'img/img13.jpg',
    'descripcion' => 'Bizcochuelo rojo con cacao, relleno y cubierto con crema de queso (cream cheese). Decoración con migas. Medida: 16 cm – 8 a 10 porciones.'
  ],
  'torta14' => [
    'nombre' => 'Red Velvet Alta',
    'imagen' => 'img/img14.jpg',
    'descripcion' => 'Torta alta de red velvet de 3 capas, con relleno de crema de queso. Decoración elegante con migas. Medida: 18 cm – 10 a 12 porciones.'
  ],
  'torta15' => [
    'nombre' => 'Red Velvet Semi Naked',
    'imagen' => 'img/img15.jpg',
    'descripcion' => 'Torta red velvet con cobertura parcial (estilo “naked”), rellena de crema de queso. Medida: 16 cm – 8 a 10 porciones.'
  ],
  'torta16' => [
    'nombre' => 'Red Velvet con Topping Extra',
    'imagen' => 'img/img16.jpg',
    'descripcion' => 'Red velvet con doble capa de frosting de queso, decorada con frambuesas y crema extra. Medida: 18 cm – 10 a 12 porciones.'
  ]
];
...
<h1>Delicias doomcakes</h1>
<section class="galeria" aria-label="Galería de tortas">
  <?php foreach ($tortasVelvet as $clave => $torta): ?>
...
<form method="POST" id="formCompra">
  ...
  <label>Tipo de torta:
    <select name="torta" id="torta" required onchange="calcularTotal()">
      ...
      <option value="torta13">Red Velvet Clásica ($10000)</option>
      <option value="torta14">Red Velvet Alta ($12000)</option>
      <option value="torta15">Red Velvet Semi Naked ($11000)</option>
      <option value="torta16">Red Velvet con Topping Extra ($13000)</option>
    </select>
  </label>
...
<?php if (isset($_SESSION['compra'])):
  $nombresTortas = [
    'torta13' => 'Red Velvet Clásica',
    'torta14' => 'Red Velvet Alta',
    'torta15' => 'Red Velvet Semi Naked',
    'torta16' => 'Red Velvet con Topping Extra'
  ];
?>
<div id="comprobante">

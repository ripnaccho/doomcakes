...
$tortas = [
  'torta5' => [
    ...
    'imagen' => 'img/img5.jpg',
    'descripcion' => 'Bizcochuelo de vainilla, relleno con crema chantilly y frutillas frescas. Decorada con crema y frutillas por encima. Medida: 14 cm de diámetro – rinde 6 a 8 porciones.'
  ],
  'torta6' => [
    'nombre' => 'Frutillas con Ganache Blanco',
    'imagen' => 'img/img6.jpg',
    'descripcion' => 'Bizcochuelo esponjoso, con relleno de crema pastelera. Decorada con frutillas enteras y baño de chocolate blanco. Medida: 14 cm – 6 a 8 porciones.'
  ],
  'torta7' => [
    'nombre' => 'Frutas Mixtas',
    'imagen' => 'img/img7.jpg',
    'descripcion' => 'Bizcochuelo de vainilla relleno con crema pastelera. Decorada con frutillas, arándanos, moras y frambuesas. Medida: 16 cm – 8 a 10 porciones.'
  ],
  'torta8' => [
    'nombre' => 'Frutal con Capas',
    'imagen' => 'img/img8.jpg',
    'descripcion' => 'Capas de bizcochuelo rellenas de crema chantilly y frutillas. Decorada con frutillas cortadas. Medida: 12 cm – 4 a 6 porciones.'
  ]
];
...
<section class="galeria" aria-label="Galería de tortas">
  <?php foreach ($tortas as $clave => $torta): ?>
...
<label>Tipo de torta:
 ...
 <option value="torta5">Frutillas con Crema ($8000)</option>
<option value="torta6">Frutillas con Ganache Blanco ($10000)</option>
<option value="torta7">Frutas Mixtas ($9000)</option>
<option value="torta8">Frutal con Capas ($8000)</option>
